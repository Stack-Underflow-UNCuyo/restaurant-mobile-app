...
export const departamentoService = {
  ...
  update: (id: string, data: DepartamentoPayload) => apiClient.put<Departamento>(`/api/v1/departamentos/${id}`, data),
  remove: (id: string) => apiClient.del(`/api/v1/departamentos/${id}`),
};
