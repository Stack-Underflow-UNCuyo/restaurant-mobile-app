...
import { Ionicons } from "@/views/components/icons";
import { ThemedText } from "@/views/components/themed-text";
import { estadoDetalleStyle } from "@/views/constants/estadoComanda";
import { Fonts, Gray, Radius, Spacing, Success } from "@/views/constants/theme";
