...
public class RestaurantDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (!cartaRepo.findAllByEliminadoFalse().isEmpty()) return;
    ...
    private record ArticuloSeed(String nombre, String descripcion, boolean sinTAC, boolean esIngrediente, String unidad) {}

    private Map<String, Articulo> crearArticulos(Map<String, UnidadDeMedida> unidades) {
        List<ArticuloSeed> seeds = List.of(
            new ArticuloSeed("Empanadas de Carne", "Empanadas criollas rellenas de carne cortada a cuchillo, porción de 3 unidades", false, false, "Porción"),
            new ArticuloSeed("Provoleta", "Provolone a la parrilla con orégano y aceite de oliva", false, false, "Porción"),
            new ArticuloSeed("Tabla de Fiambres", "Selección de fiambres y quesos artesanales para compartir", false, false, "Porción"),
            new ArticuloSeed("Bife de Chorizo", "Corte de carne vacuna a la parrilla con guarnición a elección", true, false, "Porción"),
            new ArticuloSeed("Milanesa Napolitana", "Milanesa de carne con jamón, queso y salsa de tomate", false, false, "Porción"),
            new ArticuloSeed("Pollo al Verdeo", "Suprema de pollo grillada con salsa de crema y cebolla de verdeo", true, false, "Porción"),
            new ArticuloSeed("Lomo a la Pimienta", "Lomo de res en salsa de pimienta verde con papas rústicas", true, false, "Porción"),
            new ArticuloSeed("Salmón Grillado", "Filete de salmón rosado a la plancha con vegetales salteados", true, false, "Porción"),
            new ArticuloSeed("Papas Fritas", "Papas fritas crocantes con sal, en porción para compartir", true, false, "Porción"),
            new ArticuloSeed("Sorrentinos de Jamón y Queso", "Pasta rellena casera servida con salsa rosa", false, false, "Porción"),
            new ArticuloSeed("Ñoquis de Papa", "Ñoquis caseros de papa con salsa a elección", false, false, "Porción"),
            new ArticuloSeed("Pizza Muzzarella", "Pizza grande con salsa de tomate y abundante muzzarella", false, false, "Unidad"),
            new ArticuloSeed("Pizza Especial", "Pizza grande con jamón, morrones, aceitunas y muzzarella", false, false, "Unidad"),
            new ArticuloSeed("Flan Casero", "Flan casero con dulce de leche y crema", false, false, "Porción"),
            new ArticuloSeed("Tiramisú", "Postre italiano elaborado con café, mascarpone y cacao", false, false, "Porción"),
            new ArticuloSeed("Helado Artesanal", "Dos bochas de helado artesanal a elección del cliente", true, false, "Porción"),
            new ArticuloSeed("Agua Mineral", "Botella de agua mineral de 500 ml, con o sin gas", true, false, "Mililitro"),
            new ArticuloSeed("Gaseosa Cola", "Botella de gaseosa cola de 500 ml", true, false, "Mililitro"),
            new ArticuloSeed("Cerveza Artesanal", "Cerveza artesanal estilo IPA de 500 ml", false, false, "Mililitro"),
            new ArticuloSeed("Copa de Vino Malbec", "Copa de vino tinto Malbec de la región de Mendoza", true, false, "Mililitro"),
    ...
    private Map<String, DetalleSeccionCarta> crearCartaCompleta(Map<String, Categoria> categorias, Map<String, Articulo> articulos) {
        ...
        seccionesConArticulos.put("Platos Principales", List.of(
            new DetalleArticuloSeed("Bife de Chorizo", 9800, "Incluye guarnición a elección: papas fritas, puré o ensalada"),
        ...
        seccionesConArticulos.put("Pastas y Pizzas", List.of(
            ...
            new DetalleArticuloSeed("Ñoquis de Papa", 6800, "Con salsa a elección: filetto, bolognesa o cuatro quesos"),
